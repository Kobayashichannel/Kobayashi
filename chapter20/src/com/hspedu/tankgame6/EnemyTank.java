...
public class EnemyTank extends Tank implements Runnable {
    ...
    //编写方法,判断当前的敌人这个坦克,是否和 enemyTanks 中其他的坦克发生重叠或者碰撞
    public boolean isTouchEnemyTank() {

        //判断当前敌人坦克(this) 方向
        switch (this.getDirect()) {
            case 0: //上
                //让当前敌人坦克和其他所有的敌人坦克进行比较
                for (int i = 0; i < enemyTanks.size(); i++) {
                    ...
                    if (enemyTank != this) {
                        //如果敌人坦克是 上/下
                        //老韩分析
                        //1. 如果敌人坦克是 上/下 x的范围 [enemyTank.getX(), enemyTank.getX() + 40]
                        ...
                        //如果敌人坦克是 右/左
                        //老韩分析
                        //1. 如果敌人坦克是 右/左 x的范围 [enemyTank.getX(), enemyTank.getX() + 60]
            ...
            case 2: //下
                ...
                for (int i = 0; i < enemyTanks.size(); i++) {
                    ...
                    if (enemyTank != this) {
                        ...
                        //                     y的范围 [enemyTank.getY(), enemyTank.getX() + 60]
                        if (enemyTank.getDirect() == 0 || enemyTank.getDirect() == 2) {
                            //2. 当前坦克 右上角的坐标 [this.getX(), this.getY() + 60]
                            if (this.getX() >= enemyTank.getX()
                                    && this.getX() <= enemyTank.getX() + 40
                                    && this.getY() >= enemyTank.getY()
                                    && this.getY() <= enemyTank.getY() + 60) {
