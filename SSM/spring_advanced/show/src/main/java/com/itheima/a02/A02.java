...
public class A02 {
    ...
    public static void main(String[] args) {
        testClassPathXmlApplicationContext(); //基于类路径读取xml配置
//        testFileSystemXmlApplicationContext(); //基于本地磁盘文件路径配置
//        testAnnotationConfigApplicationContext(); //基于非WEB程序的spring容器
//        testAnnotationConfigServletWebServerApplicationContext(); //基于WEB程序的spring容器
