...
public class UserClientService {
    ...
    public boolean checkUser(String userId, String pwd) throws IOException {
        boolean b = false;
        //创建User对象
        u.setUserId(userId);
        u.setPasswd(pwd);
    ...
    public void onlineFriendList() {
        ...
        try {
            ...
            ObjectOutputStream oos = new ObjectOutputStream(socket.getOutputStream());
            oos.writeObject(message); //发送一个Message,向服务端要求在线用户列表
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void logout() {
        ...
        message.setSender(u.getUserId()); //一定要指定我是哪个客户端的id
