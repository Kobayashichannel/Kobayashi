...
-- 请用mysql 的sql语句中求出你活了多少天? [练习] 1986-11-11 出生
SELECT DATEDIFF(NOW(),'1998-07-22') FROM DUAL; 
-- 如果你能活80岁, 求出你还能活多少天,[练习] 
-- 先求出活80岁,求出你还能活多少天.[练习]
-- 然后在使用 datediff(x,now());
SELECT DATEDIFF(DATE_ADD('1998-07-22', INTERVAL 80 YEAR), NOW()) FROM DUAL;
...
--
SELECT FROM_UNIXTIME(1685125074, '%Y-%m-%d') FROM DUAL;
SELECT FROM_UNIXTIME(1685125074, '%Y-%m-%d %H:%i:%s') FROM DUAL;