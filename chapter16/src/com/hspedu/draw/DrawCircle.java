...
class MyPanel extends JPanel {
    ...
    public void paint(Graphics g) { //绘图方法
        ...
        //填充矩形 fillRect(int x1, int y1, int width, int height)
        //设置画笔的颜色的演示
//        g.setColor(Color.blue);
//        g.fillRect(10,10,100,100);

        //填充椭圆 fillOval(int x1, int y1, int width, int height)
        g.setColor(Color.red);
        g.fillOval(10, 10, 100, 100);

        //画图片 drawString(String str, int x, int y, ..)
        //1. 获取图片资源, /bocchi.png 表示在该项目的根目录去获取 bocchi.png 图片资源
        //Image image = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/bocchi.png"));
        //g.drawImage(image, 10, 10, 278, 278, this);
        g.setColor(Color.red);
