...
public class HouseView {
    ...
    private boolean loop = true;//接受显示菜单
    private char key = ' '; //接受用户选择
    private HouseService houseService = new HouseService(2);//假定数组的大小为10
    ...
    public void update() {
        ...
        //因此老师在后面对house.setXxx(), 就会修改HouseService中house数组的元素！！！！
    ...
    //编写delHouse() 接受输入id,调用Service 的del方法
    ...
    public void listHouses() {
        ...
        for (int i = 0; i < houses.length; i++) {
            if (houses[i] == null) { //如果为null,就不再显示
                break;
            }
