...
public class MulForExercise01 {
	...
	public static void main(String[] args) {
		...
		//化繁为简
		//(1) 先计算一个班,5个学生的成绩
		//1.1 创建 Scanner 对象然后,使用用户输入 
		//1.2 得到该班级的平均分,定义一个 double sum 把该班级5个学生累积
        
        //(2) 统计3个班(每个班5个学生) 平均分
        //(3) 得到该班级的平均分,定义一个 double sum 把该班级5个学生的成绩累积
        ...
        for( int i = 1; i <= classNum; i++){//i 表示班级
			...
			for ( int j = 1; j <= stuNum; j++){//j 表示学生
				System.out.println("请教第"+ i +"个班的第"+ j +"个学生的成绩");
